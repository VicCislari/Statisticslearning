...
# eps-file
dev.copy2eps(file="../pictures/score_reg1.eps")

# Compute the covariance and the coefficient of correlation.
cov(results$time,results$score) # 3.25
cor(results$time,results$score) # 0.861269
# or
results %>%
...
abline(v=0)
# eps-file
dev.copy2eps(file="../pictures/score_reg2.eps")
...
# eps-file
dev.copy2eps(file="../pictures/score_reg3.eps")
